...
function Navbar() {
  ...
  const navActionsStyle = {
    ...
    gap: 'clamp(0.5rem, 2vw, 1.2rem)', // was '1.2rem'
    alignItems: 'center'
  };
  ...
  const loginBtnStyle = {
    ...
    padding: 'clamp(0.4rem, 2vw, 0.6rem) clamp(0.9rem, 4vw, 2rem)', // was '0.6rem 2rem'
    borderRadius: '50px',
    fontWeight: 600,
    fontSize: 'clamp(0.75rem, 2.2vw, 0.9rem)', // was '0.9rem'
    whiteSpace: 'nowrap',
    textDecoration: 'none',
